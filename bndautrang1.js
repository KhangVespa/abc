...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://bit.ly/2sOZQSJ' target='_blank'><img src='https://raw.githubusercontent.com/KhangVespa/90/master/bndautrang1.js' width='500px'/><br/>Cửa Hàng piaggio Trần Hưng Đạo</a>. Học tại nhà CEO Faceseo. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
